...
In the previous chapter you saw how semantic search works: embed a query, embed your documents, find the closest vectors. That's great when you have a few hundred documents. But what happens when you have a million?
